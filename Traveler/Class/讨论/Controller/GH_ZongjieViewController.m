...
@interface GH_ZongjieViewController ()<UITableViewDelegate, UITableViewDataSource>
@property (nonatomic, strong)UITableView * table;
@end

@implementation GH_ZongjieViewController
...
- (UITableView *)table{
    if (!_table) {
        ...
        footerView.frame = CGRectMake(0, 0, screenWidth, 100);
